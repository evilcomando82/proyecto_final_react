        ...
        <>
            ...
            <div className="row my-1">
                <div className="col-md-5">
                    {itemAdded ? <Link to={"/cart"} className="btn btn-warning">Terminar compra</Link> : <button type="button" className="btn btn-warning" onClick={addToCart}>Agregar al Carrito</button>}
                </div>
            </div>
        </>
    )
